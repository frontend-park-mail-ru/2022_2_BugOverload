...
app.get('/v1/in_cinema', (req, res) => {
	...
	const collectionCinemaTodayData = {
		...
		films:[
		{
			...
			duration: "",
			posterHuge: "",
			poster_v: "asserts/img/posters/dune_poster.jpg",
			ratio: 9.8,
		...
		},
		{
			...
			duration: "",
			posterHuge: "",
			poster_v: "asserts/img/posters/2.png",
			ratio: 7.1,
			genres: ["Фентези", "Приключения"],
		},
		{
			...
			duration: "",
			posterHuge: "",
			poster_v: "asserts/img/posters/3.png",
			ratio: 7.1,
			genres: ["Фентези", "Приключения"],
		},
		{
			...
			duration: "",
			posterHuge: "",
			poster_v: "asserts/img/posters/4.png",
			ratio: 9.1,
			genres: ["Фентези", "Приключения"],
		},
		{
			...
			duration: "",
			posterHuge: "",
			poster_v: "asserts/img/posters/5.png",
			ratio: 7.1,
			genres: ["Фентези", "Приключения"],
		},
		{
			...
			duration: "",
			posterHuge: "",
			poster_v: "asserts/img/posters/8.png",
			ratio: 7.1,
			genres: ["Фентези", "Приключения"],
		},
		{
			...
			duration: "",
			posterHuge: "",
			poster_v: "asserts/img/posters/9.png",
			ratio: 7.1,
			genres: ["Фентези", "Приключения"],
		},
		{
		...
		},
		{
			...
			duration: "",
			posterHuge: "",
			poster_v: "asserts/img/posters/7.png",
			ratio: 7.1,
			genres: ["Фентези", "Приключения"],
		},
		{
			...
			duration: "",
			posterHuge: "",
			poster_v: "asserts/img/posters/6.png",
			ratio: 7.1,
			genres: ["Фентези", "Приключения"],
		},
		{
...
app.get('/v1/recommendation_film', (req, res) => {
	...
	const previewSpace = {
		...
		ageLimit: "",
		duration: "",
		poster_h: "asserts/img/space_odyssey_hor.jpg",
		ratio: 7.1,
		genres: ["Фентези", "Приключения"]
	}
	...
	const previewJoker = {
		...
		ageLimit: "18+",
		duration: "2:10",
		poster_h: "asserts/img/joker_hor.jpg",
		ratio: 7.1,
	}
	...
	const previewStarWars = {
		...
		ageLimit: "",
		duration: "",
		poster_h: "asserts/img/StarWars.jpeg",
		ratio: 7.1,
		genres: ["Фентези", "Приключения"]
	}
